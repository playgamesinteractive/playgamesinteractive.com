...
const DownloadButtons: React.FC = () => {
  return (
    <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
      ...
      <Link
        href="https://play.google.com/store/apps/details?id=com.audn.gympal&hl=en"
        aria-label="Get it on Google Play"
      >
        <button className="px-4 h-[55px] hover:bg-opacity-50  bg-white text-black rounded-xl flex items-center justify-center space-x-2  transition-colors duration-300">
